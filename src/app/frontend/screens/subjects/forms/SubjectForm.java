...
/**
 * Uma janela de formulário para gerenciar informações de disciplinas
 * acadêmicas.
 */
public class SubjectForm extends JFrame {
  ...
  /**
   * Tipo de ação a ser executada na janela do formulário (Editar, Adicionar ou
   * Visualizar).
   */
  ...
  /**
   * Construtor para a janela do formulário de disciplina.
   *
   * @param subjectTableModel O modelo da tabela de disciplinas associado.
   * @param actionType        O tipo de ação a ser executada (Editar, Adicionar ou
   *                          Visualizar).
   */
  ...
  /**
   * Construtor para a janela do formulário de disciplina com um professor
   * associado.
   *
   * @param subjectTableModel O modelo da tabela de disciplinas associado.
   * @param actionType        O tipo de ação a ser executada (Editar, Adicionar ou
   *                          Visualizar).
   * @param teacher           O professor associado à disciplina (opcional).
   */
  ...
  /**
   * Construtor para a janela do formulário de disciplina com dados de disciplina
   * existentes.
   *
   * @param subjectTableModel O modelo da tabela de disciplinas associado.
   * @param actionType        O tipo de ação a ser executada (Editar ou
   *                          Visualizar).
   * @param subject           A disciplina cujos dados devem ser exibidos ou
   *                          editados.
   * @param teacher           O professor associado à disciplina (opcional).
   */
  public SubjectForm(SubjectTableModel subjectTableModel, SubjectActionType actionType, Subjects subject) {
  ...
  /**
   * Cria e retorna um painel de formulário com campos para entrada de dados.
   *
   * @return Um JScrollPane contendo o painel de formulário.
   */
   ...
   *
   * @param text O texto do rótulo de seção.
  ...
  /**
   * Cria e retorna um painel de botões para a janela do formulário.
   *
   * @return Um JPanel com botões, como "Cancelar" e "Confirmar".
   */
  ...
  /**
   * Manipula a ação de confirmação (Salvar ou Atualizar) no formulário.
   */
