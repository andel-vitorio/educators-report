...
/**
 * Uma classe que representa o formulário de atividade de coordenação.
 */
public class CoordinationActivityForm extends JFrame {
  ...
  /**
   * Os tipos de ação que podem ser realizados neste formulário.
   */
  ...
  /**
   * Cria uma instância de CoordinationActivityForm.
   *
   * @param coordinationActivityTableModel O modelo de tabela para atividades de
   *                                       coordenação.
   * @param actionType                     O tipo de ação a ser realizada.
   * @param teacher                        O professor associado à atividade (pode
   *                                       ser nulo).
   */
  public CoordinationActivityForm(CoordinationActivityTableModel coordinationActivityTableModel,
      CoordinationActivityActionType actionType, Teacher teacher) {
   ...
   */
  public CoordinationActivityForm(CoordinationActivityTableModel coordinationActivityTableModel,
      CoordinationActivityActionType actionType) {
    super("");
  ...
  /**
   * Cria uma instância de CoordinationActivityForm para edição.
   *
   * @param coordinationActivityTableModel O modelo de tabela para atividades de
   *                                       coordenação.
   * @param actionType                     O tipo de ação a ser realizada.
   * @param activity                       A atividade de coordenação a ser
   *                                       editada.
   * @param teacher                        O professor associado à atividade (pode
   *                                       ser nulo).
   */
  ...
  /**
   * Obtém o contêiner do formulário.
   *
   * @return O contêiner do formulário.
   */
  private JScrollPane getFormContainer() {
    ...
    constraints.gridx = 0;
    constraints.gridy = y++;
    nameOfPersonResponsibleFormField = new FormField("Nome Completo do Responsável", 0);
  ...
  /**
   * Obtém um rótulo para uma seção do formulário.
   *
   * @param text O texto do rótulo.
   * @return O rótulo da seção.
   */
  ...
  /**
   * Obtém o contêiner de botões do formulário.
   *
   * @return O contêiner de botões do formulário.
   */
  ...
  /**
   * Confirma a ação realizada no formulário.
   */
  private void confirm() {
    ...
    if (isEditable) {
      ...
      if (coordinationActivityActionType == CoordinationActivityActionType.ADD_ACTIVITY)
        CoordinationActivityService.postCoordinationActivity(coordinationActivity);
      else if (coordinationActivityActionType == CoordinationActivityActionType.EDIT_ACTIVITY)
        CoordinationActivityService.updateCoordinationActivityById(coordinationActivity.getId(),
            coordinationActivity);

      if (teacher == null)
        coordinationActivityTableModel
            .setCoordinationActivityList(CoordinationActivityService.getCoordinationActivities());
      else {
